...
<div class="lesson-block" markdown="1">
<h3>12. 60-Minute Teaching Outline (You Can Use This As Your Live Lesson Plan)</h3>

**0–5 min — Framing**
- Why we use the Terminal (speed, control, needed for Git & deployment).
- Reassure: “We’re not becoming hackers; we’re just learning the basics.”

**5–15 min — Opening Terminal & Prompt**
- Open Terminal.
- Show `pwd`, explain the prompt.
- Show `ls`, `ls -al`.

**15–30 min — Navigation**
- Practice: `cd ~`, `cd Desktop`, `cd ..`, `cd ~/Documents`.
- Tab completion demo and practice.
- **Quick challenge:** “From home, navigate to Desktop, create a folder, then move into it.”

**30–45 min — Files & Folders**
- `mkdir`, `touch`, `rm`, `cp`, `mv`.
- Show `open .` and `open index.html`.
...
**45–55 min — Editors & Troubleshooting**
- Try `code .` (for those using VS Code).
- If command not found, walk through the “Install 'code' command in PATH” steps.
- Try `cursor .` if relevant; explain the pattern of installing a shell command.
- Show `cat` and `less`.

**55–60 min — Wrap-Up & Homework**
- Recap the main commands: `pwd`, `ls`, `cd`, `mkdir`, `touch`, `rm`, `mv`, `cp`, `open`, `code .` / `cursor .`.

**Homework idea:**
> “Create a web-projects folder on your Desktop. Inside it, create one folder for each idea you have for a website, each with an index.html file. Use only the command line to set this up.”
</div>
